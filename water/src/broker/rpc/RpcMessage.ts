...
import type { RpcMessageHeaders } from "./RpcMessageHeaders.js";
import type { RpcStatus } from "./RpcStatus.js";

export type RpcResponse<ResponseT> = [RpcStatus, ResponseT];

export class RpcRequestMessage<RequestT, ResponseT, H extends BrokerMessageHeaders = BrokerMessageHeaders>
