...
export interface IBrokerConnection {
	...
	send(topic: string, key: string, value: string, headers: IBrokerMessageHeaders): Promise<string>;

	createHeaders(targetClusters?: Set<string>, requestId?: string): IBrokerMessageHeaders;
}
